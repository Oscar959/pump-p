                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body text-secondary" style="font-style:italic">
                                        ...
                                        Vous avez la possibilités <strong>de communiquer le public tous ce qui se passe concernant les formations et des activités qu'organisent l'UMP.</strong>
										...
										Cliquez sur le titre en bas si vous etes sur un télephone ou à gauche si vous etes sur écran large comme celui d'un ordinateur <strong class="font-weight-bold text-primary">Publiez une activités, une formations pour le public</strong> et remplissez toutes les informations démandées.
                                        ...
                                        <form id="form" enctype="multipart/form-data">
										  <div class="row">
											...
											<div class="col-md-12 form-group ">
												...
												<textarea class="form-control" name="objet" id="objet" rows="3" ></textarea>
											  </div>
										  ...
										  <div class="text-center" style="margin:0.5rem;"><button type="submit" id="sent" name="sent" class="btn btn-primary" style="font-style:italic"><i class="fa fa-upload"></i></button></div>
                                      </form>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
	  $(document).ready(function(){
		  $('#form').on('submit', function(e){
			e.preventDefault();
			  if($('#titre').val()!= '' && $('#message').val()!='' && $('#objet').val()!=''  && $('#files').val()!=''){
				 $.ajax({
