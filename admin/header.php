...
<!-- ======= Top Bar ======= -->
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="../">UMP/ONGD</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="../docteur">Comité Directeur</a></li>
           ...
           <li class="dropdown"><a href="#"><span>Organisations</span> <i class="bi bi-chevron-down"></i></a>
				...
				<li class="dropdown"><a href="#"><span>Nous ecrire...</span> <i class="bi bi-chevron-down"></i></a>
					<ul>
						...
						<li><a href="../service_asked">Pour une démande service</a></li>
					</ul>
				</li>
				</ul>
          </li>
