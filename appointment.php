    ...
    <section id="appointment" class="" style="margin:1rem; margin-top:5rem;">
      <div class="container">
        ...
        <div class="section-title">
          <h2 style="text-align:center; font-style:italic;text-transform:capitalize;font-family: 'Nunito', sans-serif;">écrivez nous pour un rendez vous avec le comité directeur</h2>
          <p style="text-align:center; font-style:italic;">Cher visiteur nous vous demendons de nous écrire tout en remplissant le formulaire pour un rendez-vous avec le comité directeur de l'UMP.
