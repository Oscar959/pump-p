...
<head>
    ...
    <title>membres non confirmé</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body text-secondary" style="font-style:italic">
									    Votre raison dans cette page peut être soit nous avons reussi votre demande d'inscription mais vous n'êtes pas encore confirmé ou soit vous êtes banis de 
                                        chez les admnistrateurs pour une quelconque raison. Si vous avez créé votre compte, rassurez-vous que nous avons reussi 
						...
						<div class="alert alert-success  alert-dismissable col-lg-4" style="display: none">
							...
							<h4>Reussie</h4> 
							<p style="text-align:justify">Votre message à été soumis avec succès. L'UMP vous remercie de la confiance que vous lui faites.</p>
						</div>
