    ...
    <section id="appointment" class="" style="margin:1rem; margin-top:5rem;">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p style="text-align:justify; font-style:italic; font-family: 'Nunito', sans-serif; ">Cher visiteur nous vous demendons de nous écrire tout en remplissant le formulaire pour un rendez-vous de consultation chez vous.
		...
		<div class="alert alert-success  alert-dismissable col-lg-4" style="display: none">
					...
					<h4>Reussie</h4> 
					<p style="text-align:justify; font-family: 'Nunito', sans-serif; ">Votre demende de rendez-vous à été soumise avec succès. L'UMP vous remercie de la confiance que vous lui faites</p>
		</div>
        ...
        <form id="form">
          ...
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3">
			<small> Votre téléphone(+243)</small>
